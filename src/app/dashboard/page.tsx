    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="p-6">
        <div className="grid grid-cols-2 gap-4 max-w-md">
          ...
          <Link
            href="/contratos-a-terminar"
            className="bg-white border border-gray-200 rounded-xl p-6 hover:border-amber-300 hover:shadow-sm transition"
          >
            <div className="text-2xl mb-2">📅</div>
            <h2 className="font-semibold text-gray-900">Contratos a Terminar</h2>
            <p className="text-sm text-gray-500 mt-1">Lista por data de término</p>
          </Link>
          ...
          {session.user?.role === "MASTER" && (
            <Link
              href="/admin/enriquecer"
              className="bg-white border border-gray-200 rounded-xl p-6 hover:border-blue-300 hover:shadow-sm transition"
            >
              <div className="text-2xl mb-2">🔍</div>
              <h2 className="font-semibold text-gray-900">Enriquecer Contactos</h2>
